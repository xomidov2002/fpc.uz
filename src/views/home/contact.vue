...
const sendMessage = async () => {
  ...
  const url =
    'https://api.telegram.org/bot6760739912:AAFVrqguAFvYZ1cDFjCCJyK2cFSoTTatgIM/sendMessage'
  const data = {
    chat_id: '-4102543534',
        ...
        <div class="p-4">
          <div class="form-container bg-none rounded-2xl">
            <div class="form">
              ...
              <BaseButton
                @click="sendMessage"
                :name="isSubmitting ? t('mainPage.sending') : t('mainPage.Submit')"
              />
              <!-- Notification Messages -->
              <transition name="fade">
                <div
                  class="absolute uppercase -bottom-[30%] -right-[11%] p-5 border-r-8 border-r-[#080D75] bg-[#14151B]"
